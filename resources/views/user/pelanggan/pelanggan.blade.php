        ...
        methods: {
            ...
            async actionTambah(){
                ...
                try{
                    ...
                    await axios.post('pelanggan', this.form)
            ...
            async edit(id){
                ...
                let response = await axios.get('pelanggan/'+ id)
            ...
            async actionEdit(id){
                ...
                try{
                    ...
                    await axios.patch('pelanggan/'+ id, this.formEdit)
                    $('#table').DataTable().ajax.reload()
                    $('.btn-close').click()

                    Toast.fire({
                        icon: 'success',
                        title: 'Pelanggan berhasil di edit'
                    })
            ...
            hapus(id){
                Swal.fire({
                    ...
                    text: "ingin menghapus pelanggan ini",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        ...
                        Toast.fire({
                            icon: 'success',
                            title: 'pelanggan berhasil di hapus'
                        })
                    }
                })
            }
